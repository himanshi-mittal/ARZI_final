    ...
    return Scaffold(
      ...
      drawer: new Drawer(
        child: ListView(
            children:
            <Widget>[
              new UserAccountsDrawerHeader(accountName: Text("Himanshi Mittal"),
                accountEmail: Text("hmittal_be18@thapar.edu"),
              ...
              new ListTile(
                ...
                onTap: ()
                {
                  ...
                  Navigator.push(context, new MaterialPageRoute(
                      builder: (BuildContext context) => new AnnouncementsPage() )
                  );
                },
              ),
              new ListTile(
